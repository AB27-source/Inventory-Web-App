                ...
                <td className="p-2">
                  <div className="flex items-center">
                    {/* <svg className="shrink-0 mr-2 sm:mr-3" width="36" height="36" viewBox="0 0 36 36"> */}
                      ...
                      /> */}
                    {/* </svg> */}
                    <div className="text-slate-800 dark:text-slate-100">SAMPLE 1</div>
                  </div>
                </td>
                <td className="p-2">
                ...
                <td className="p-2">
                  <div className="flex items-center">
                    {/* <svg className="shrink-0 mr-2 sm:mr-3" width="36" height="36" viewBox="0 0 36 36"> */}
                      ...
                      /> */}
                    {/* </svg> */}
                    <div className="text-slate-800 dark:text-slate-100">SAMPLE 2</div>
                  </div>
                </td>
                <td className="p-2">
                ...
                <td className="p-2">
                  <div className="flex items-center">
                    {/* <svg className="shrink-0 mr-2 sm:mr-3" width="36" height="36" viewBox="0 0 36 36"> */}
                      ...
                      /> */}
                    {/* </svg> */}
                    <div className="text-slate-800 dark:text-slate-100">SAMPLE 3</div>
                  </div>
                </td>
                <td className="p-2">
                ...
                <td className="p-2">
                  <div className="flex items-center">
                    {/* <svg className="shrink-0 mr-2 sm:mr-3" width="36" height="36" viewBox="0 0 36 36"> */}
                      ...
                      /> */}
                    {/* </svg> */}
                    <div className="text-slate-800 dark:text-slate-100">SAMPLE 4</div>
                  </div>
                </td>
                <td className="p-2">
                ...
                <td className="p-2">
                  <div className="flex items-center">
                    {/* <svg className="shrink-0 mr-2 sm:mr-3" width="36" height="36" viewBox="0 0 36 36"> */}
                      ...
                      /> */}
                    {/* </svg> */}
                    <div className="text-slate-800 dark:text-slate-100">SAMPLE 5</div>
                  </div>
                </td>
                <td className="p-2">
